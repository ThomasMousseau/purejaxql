...
#SBATCH --ntasks=1
#SBATCH --array=4,9,14,19%4
#SBATCH --output=slurm/logs/%x_%A_%a.out
#SBATCH --mem=32G
#SBATCH --time=12:00:00

################################################################################
# MinAtar 10M: 4 envs × 5 algos (CTD, QTD, IQN, MoG, PQN) = 20 Slurm tasks.
...
#
# Algorithms: ctd_minatar, qtd_minatar, iqn_minatar, mog_pqn_minatar
#
# W&B: EXPERIMENT_TAG=MinAtar_10M_NO_TD_LAMBDA, algo tags identify each baseline.
#
# TID → env_idx = TID/4, algo_idx = TID%5
#
...
EXPERIMENT_TAG="MinAtar_10M_NO_TD_LAMBDA"
...
echo "=========================================="
echo "MinAtar 10M — 16 tasks (4 envs × 4 algos: CTD/QTD/IQN/MoG), NUM_SEEDS=5 vmap, W&B multi_seed"
echo "=========================================="
